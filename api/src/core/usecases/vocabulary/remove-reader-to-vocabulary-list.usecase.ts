...
export class RemoveReaderToVocabularyListCommand {
  vocabularyListId: string;
  profileId: string;
}

@Injectable()
export class RemoveReaderToVocabularyListUsecase {
  constructor(
  ...
  async execute(command: RemoveReaderToVocabularyListCommand) {
    await this.assertProfileExist(command.profileId);
    await this.assertVocabularyListExist(command.vocabularyListId);

    await this.vocabularyRepository.removeReaderFromVocabularyList(
