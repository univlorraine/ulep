            ...
            <div className={styles.contentContainer}>
                ...
                <div className={styles.descriptionContainer}>
                    ...
                    <p className={styles.description}>
                        {note === 100
                            ? t('flashcards.flipcards.finish.perfect_score')
                            : t('flashcards.flipcards.finish.paragraph2')}
                    </p>
                </div>
            </div>
            <div className={styles.buttonsContainer}>
                <IonButton fill="clear" className={'primary-button'} onClick={onRestartedQuiz} size="small">
                    <IonText>{t('flashcards.flipcards.buttons.restart')}</IonText>
                </IonButton>
                <IonButton fill="clear" className={'secondary-button'} onClick={onBackToVocabularyList} size="small">
